...
function fidelityMessage() {
  ...
  return "This run drifted from the plan. Focus on: (a) proactive setup, (b) prompting & reinforcing the replacement behavior, and (c) using the crisis steps as written. Replay to improve fidelty to the plan.";
}
...
const RESULT_ENDPOINT = "https://script.google.com/macros/s/AKfycbz3t62z14WiNwElVMBjm5nRFZAU85z4R56zr3B46HmJQcx9g5itS1RxIuxIhgsbnNsC/exec";
