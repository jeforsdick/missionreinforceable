      ...
      step1: {
        ...
        choices: {
          A: {
            ...
            wizard: `The Wizard lowers the heat in the room. The writing task is no longer a mountain, but it also does not disappear. Student gets two safe paths, and both lead back to one small mark. ABA Anchor: A planned reset or reduced first step can interrupt escape while preserving re-entry.`,
          ...
          B: {
            ...
            wizard: `The Wizard hears the kindness, but Student hears the whole sentence. His pencil does not move. The writing task still feels too big, and the peer is now watching the struggle. ABA Anchor: During escalation, the first response must be very small and observable.`,
            next: "step2_wobble",
            meta: {
              bipComponent: "Respond",
              mechanism: "Prompting",
          ...
          C: {
            ...
            wizard: `The Wizard's warning flame rises. The page becomes a locked gate. Student pushes back harder because the only escape route now appears to be escalation. ABA Anchor: High-pressure language can strengthen escape-maintained refusal.`,
      ...
      step2_supported: {
        ...
        choices: {
          A: {
            ...
            wizard: `The Wizard starts the timer like a bridge, not a tunnel. Student can breathe, but the writing path remains visible. The reset becomes part of the plan instead of a full escape. ABA Anchor: Breaks are strongest when brief, predictable, and tied to re-entry.`,
            next: "step3_strong",
            meta: {
              bipComponent: "Respond",
              mechanism: "Adaptation",
          ...
          B: {
            ...
            wizard: `The Wizard watches the bridge stretch too far. Student calms, but the writing task drifts away. Without a clear return point, reset can become avoidance. ABA Anchor: Open-ended breaks can strengthen escape if re-entry is not planned.`,
            next: "step3_mixed",
            meta: {
              bipComponent: "Respond",
              mechanism: "Adaptation",
          ...
          C: {
            ...
            wizard: `The Wizard's timer cracks. The reset stops feeling like regulation and starts feeling like a lecture. Student's shoulders rise again. ABA Anchor: Process later, after regulation and successful re-entry.`,
            next: "step3_risk",
            meta: {
              bipComponent: "Respond",
              mechanism: "Performance feedback",
      ...
      step2_wobble: {
        ...
        choices: {
          A: {
            ...
            wizard: `The Wizard points to the pencil and shrinks the assignment. Student can start with action instead of arguing about the whole page. ABA Anchor: A small observable response competes with escape better than general encouragement.`,
          ...
          B: {
            ...
            wizard: `The Wizard steps back with you. The conflict lowers, but the page remains untouched. Student may calm, or he may learn that waiting makes writing disappear. ABA Anchor: Space should include a return step when escape is the likely function.`,
            next: "step3_mixed",
            meta: {
              bipComponent: "Respond",
              mechanism: "Adaptation",
          ...
          C: {
            ...
            wizard: `The Wizard darkens the page. Writing now predicts losing something later. The task becomes heavier, and Student's refusal gains emotional fuel. ABA Anchor: Threats add aversiveness without teaching task re-entry.`,
            next: "step3_risk",
            meta: {
              bipComponent: "Respond",
              mechanism: "Performance feedback",
      ...
      step2_escalated: {
        ...
        choices: {
          A: {
            ...
            wizard: `The Wizard pulls the spotlight down. You do not argue with the statement. The reset gives Student an off-ramp while the page remains part of the mission path. ABA Anchor: Reducing language and preserving re-entry helps interrupt escalation without reinforcing full escape.`,
            next: "step3_recovered",
            meta: {
              bipComponent: "Respond",
              mechanism: "Adaptation",
          ...
          B: {
            ...
            wizard: `The Wizard sees the room quieting, but the page has vanished from the immediate routine. Calm may return, yet writing has not been rebuilt. ABA Anchor: Reducing interaction should be followed by low-demand re-entry.`,
            next: "step3_mixed",
            meta: {
              bipComponent: "Respond",
              mechanism: "Adaptation",
          ...
          C: {
            ...
            wizard: `The Wizard's alarm rings. The mission shifts from writing to disrespect. Student now has a bigger conflict to escape, and peers are still watching. ABA Anchor: Address respect later, after regulation and re-entry are stable.`,
            next: "step3_risk",
            meta: {
              bipComponent: "Respond",
              mechanism: "Performance feedback",
      ...
      step3_strong: {
        ...
        choices: {
          A: {
            ...
            wizard: `The Wizard lights the first word. Student does something small and successful. The refusal loses power because re-entry is now the behavior that gets reinforced. ABA Anchor: Planned resets should end with a reinforced replacement response.`,
            ending: "success",
            meta: {
          ...
          B: {
            ...
            wizard: `The Wizard waits beside the desk. Calm is valuable, but the task bridge is fading. The longer writing stays away, the harder it may be to return. ABA Anchor: Regulation should lead into a predictable, low-demand task step.`,
            ending: "mixed",
            meta: {
              bipComponent: "Respond",
              mechanism: "Adaptation",
          ...
          C: {
            ...
            wizard: `The Wizard raises a hand. Student was almost back. The explanation demand pulls him into talking about the task instead of starting it. ABA Anchor: Reflection comes after re-entry and reinforcement, not before.`,
            ending: "mixed",
            meta: {
              bipComponent: "Respond",
              mechanism: "Adaptation",
      ...
      step3_recovered: {
        ...
        choices: {
          A: {
            ...
            wizard: `The Wizard repairs the page one mark at a time. Student gets credit for returning, then receives a step small enough to contact success. ABA Anchor: Re-entry should be reinforced before increasing task expectations.`,
            ending: "success",
            meta: {
              bipComponent: "Reinforce",
          ...
          B: {
            ...
            wizard: `The Wizard waits by the paper. The storm is smaller, but the skill is still thin. Student has proximity to writing, not a reinforced writing response. ABA Anchor: Quiet is not the same as re-entry.`,
            ending: "mixed",
            meta: {
              bipComponent: "Teach",
              mechanism: "Prompting",
          ...
          C: {
            ...
            wizard: `The Wizard sees the old doorway reopen. Student was near the page, but now the conversation becomes the task. The pencil waits again. ABA Anchor: Teach through reinforced action first, then problem solve later.`,
            ending: "mixed",
            meta: {
              bipComponent: "Respond",
              mechanism: "Performance feedback",
      ...
      step3_mixed: {
        ...
        choices: {
          A: {
            ...
            wizard: `The Wizard places the pencil back in the story. The first mark matters. Student learns that calm return to work, not refusal, changes the outcome. ABA Anchor: Repair is strongest when re-entry contacts immediate reinforcement.`,
            ending: "success",
            meta: {
              bipComponent: "Reinforce",
              mechanism: "Performance feedback",
          ...
          B: {
            ...
            wizard: `The Wizard closes the notebook halfway. The crisis is quieter, but the assignment escaped the moment. Tomorrow may bring the same battle. ABA Anchor: Re-entry should happen in the current routine when safe and feasible.`,
            ending: "mixed",
            meta: {
              bipComponent: "Respond",
              mechanism: "Adaptation",
          ...
          C: {
            ...
            wizard: `The Wizard's warning light returns. The task has become a promise Student must make under pressure. The refusal story comes back to life. ABA Anchor: Recovery should focus on safe action, not verbal compliance.`,
            ending: "fail",
            meta: {
              bipComponent: "Respond",
              mechanism: "Performance feedback",
      ...
      step3_risk: {
        ...
        choices: {
          A: {
            ...
            wizard: `The Wizard pulls the mission away from the cliff. It is not a clean win, but the episode stops growing. A small re-entry path remains possible. ABA Anchor: In crisis recovery, lowering pressure while preserving re-entry is better than forcing compliance.`,
            ending: "mixed",
            meta: {
              bipComponent: "Respond",
              mechanism: "Adaptation",
          ...
          B: {
            ...
            wizard: `The Wizard stands quietly. Waiting may prevent more damage, but the routine remains unfinished. Student is contained more than coached. ABA Anchor: Stabilization is useful, but the plan still needs low-demand re-entry when possible.`,
            ending: "mixed",
            meta: {
              bipComponent: "Respond",
              mechanism: "Adaptation",
          ...
          C: {
            ...
            wizard: `The Wizard's alarm grows louder. The explanation becomes the new demand. Student argues, the task stays gone, and the cycle strengthens. ABA Anchor: Extended language can function as adult attention and escape from writing.`,
            ending: "fail",
            meta: {
              bipComponent: "Respond",
              mechanism: "Performance feedback",
