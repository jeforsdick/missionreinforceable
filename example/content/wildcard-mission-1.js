      ...
      step1: {
        ...
        choices: {
          ...
          B: {
            ...
            wizard: `The Wizard snaps the long scroll into a two-step map. First door, then art room. Student gets a job that keeps him with the class instead of outside the routine. ABA Anchor: First-then language and job choice reduce uncertainty while preserving access to the transition.`,
          ...
          C: {
            ...
            wizard: `The Wizard's warning flame lights the doorway. The unexpected change now feels like a public demand, and Student has more reason to resist it. Several students watch to see what happens next. ABA Anchor: Pressure without predictability can make escape more valuable.`,
      ...
      step2_supported: {
        ...
        choices: {
          A: {
            ...
            wizard: `The Wizard places three glowing footprints by the door. Student now has a job, a number, and a destination. The transition becomes something to do, not something to debate. ABA Anchor: A visible first action helps Student contact success during uncertainty.`,
            next: "step3_strong",
            meta: {
              bipComponent: "Teach",
          ...
          B: {
            ...
            wizard: `The Wizard walks beside the line, but the reassurance becomes the soundtrack of the change. Student keeps checking your face instead of using the job. ABA Anchor: Adult support should point Student toward the replacement behavior, not become the whole coping strategy.`,
            next: "step3_mixed",
            meta: {
              bipComponent: "Teach",
              mechanism: "Prompting",
          ...
          C: {
            ...
            wizard: `The Wizard sees the job card turn into a spotlight. The whole class now knows Student's performance matters. What could have been quiet structure becomes public pressure. ABA Anchor: When attention is part of the pathway, jobs should be supportive, not spotlighted.`,
            next: "step3_mixed",
            meta: {
      ...
      step2_wobble: {
        ...
        choices: {
          A: {
            ...
            wizard: `The Wizard sees the question door open twice. Student receives more explanation, and the hallway waits. Safe walking may still happen, but repeated questions are becoming a way to slow the change. ABA Anchor: Repeated explanation can maintain delay when uncertainty is high.`,
            next: "step3_mixed",
            meta: {
              bipComponent: "Respond",
          ...
          B: {
            ...
            wizard: `The Wizard closes the question scroll and opens a map. Student gets the next step without needing the whole story. The transition starts moving again. ABA Anchor: First-then language plus choice interrupts delay and prompts flexible movement.`,
          ...
          C: {
            ...
            wizard: `The Wizard hears the hallway go quiet. Student feels every peer waiting on him, and the transition becomes heavier. The question is no longer about the art room. It is about the audience. ABA Anchor: Public pressure can strengthen attention and escape pathways.`,
            next: "step3_risk",
            meta: {
              bipComponent: "Respond",
              mechanism: "Performance feedback",
      ...
      step2_escalated: {
        ...
        choices: {
          A: {
            ...
            wizard: `The Wizard cuts the audience cord. Student gets a way to move without losing face. The mission can still recover because both choices lead back to the transition. ABA Anchor: Safe choices preserve access while reducing escalation.`,
            next: "step3_recovered",
            meta: {
              bipComponent: "Respond",
              mechanism: "Adaptation",
          ...
          B: {
            ...
            wizard: `The Wizard watches the class leave. The audience gets smaller, which helps, but Student also escaped the group transition. The return path still needs rebuilding. ABA Anchor: Stabilization should be followed by a low-demand re-entry step.`,
            next: "step3_mixed",
            meta: {
              bipComponent: "Respond",
              mechanism: "Adaptation",
          ...
          C: {
            ...
            wizard: `The Wizard's red flame rises. The art room now predicts losing something. Student digs in because the transition feels even more dangerous. ABA Anchor: Threats add pressure without teaching the replacement response.`,
            next: "step3_risk",
            meta: {
              bipComponent: "Respond",
              mechanism: "Performance feedback",
      ...
      step3_strong: {
        ...
        choices: {
          A: {
            ...
            wizard: `The Wizard lights the hallway like a safe path. Student learns that moving with the group and using the job earns reinforcement. The unexpected change becomes practice, not escape. ABA Anchor: Reinforcing flexibility during the change builds future transition fluency.`,
            ending: "success",
            meta: {
              bipComponent: "Reinforce",
              mechanism: "Performance feedback",
          ...
          B: {
            ...
            wizard: `The Wizard watches the job success travel down the hall without a signal. Student is doing the hard part now, but the consequence is waiting somewhere else. ABA Anchor: Reinforce the flexible response while it is happening.`,
            ending: "mixed",
            meta: {
              bipComponent: "Reinforce",
              mechanism: "Performance feedback",
          ...
          C: {
            ...
            wizard: `The Wizard's hallway lights swing toward Student. The class hears his history with changes, and the quiet job becomes public performance. ABA Anchor: Reinforcement should be private when public attention can strengthen behavior.`,
            ending: "mixed",
            meta: {
              bipComponent: "Reinforce",
              mechanism: "Performance feedback",
      ...
      step3_recovered: {
        ...
        choices: {
          A: {
            ...
            wizard: `The Wizard rebuilds the hallway bridge one plank at a time. Student gets credit for moving toward the routine, then receives a small job that keeps him with the class. ABA Anchor: Re-entry plus a low-demand action builds flexible transition behavior.`,
            ending: "success",
            meta: {
              bipComponent: "Reinforce",
              mechanism: "Fluency building",
          ...
          B: {
            ...
            wizard: `The Wizard keeps the hallway quiet, which matters. But Student's successful return slips by without a clear signal. ABA Anchor: Reinforcement can be private and still be immediate.`,
            ending: "mixed",
            meta: {
              bipComponent: "Reinforce",
              mechanism: "Performance feedback",
          ...
          C: {
            ...
            wizard: `The Wizard sees the bridge pause just before Student crosses it. The refusal story returns, and the art room waits in the distance. ABA Anchor: Process later, after regulation and successful re-entry.`,
            ending: "mixed",
            meta: {
              bipComponent: "Respond",
              mechanism: "Adaptation",
      ...
      step3_mixed: {
        ...
        choices: {
          A: {
            ...
            wizard: `The Wizard hands Student a small piece of the map. One independent step gets reinforced, and adult support can begin to fade. ABA Anchor: The goal is not just calm movement, but reinforced flexible participation.`,
            ending: "success",
            meta: {
              bipComponent: "Teach",
              mechanism: "Fluency building",
          ...
          B: {
            ...
            wizard: `The Wizard watches the support stretch. Student stays near the routine, but he keeps borrowing your calm instead of practicing his own transition step. ABA Anchor: Adult support should fade toward a reinforced replacement behavior.`,
            ending: "mixed",
            meta: {
              bipComponent: "Teach",
              mechanism: "Prompting",
          ...
          C: {
            ...
            wizard: `The Wizard's glow dims. The transition ends with pressure, not confidence. Student may dread the next surprise even more. ABA Anchor: Feedback after difficulty should strengthen the replacement path, not increase aversiveness.`,
            ending: "fail",
            meta: {
              bipComponent: "Respond",
              mechanism: "Performance feedback",
      ...
      step3_risk: {
        ...
        choices: {
          A: {
            ...
            wizard: `The Wizard places a small job at the doorway. Student can rejoin without having to prove he is over it. The mission stabilizes because the next step is tiny and reinforced. ABA Anchor: Low-demand re-entry protects access while reducing escape payoff.`,
            ending: "mixed",
            meta: {
              bipComponent: "Respond",
              mechanism: "Adaptation",
          ...
          B: {
            ...
            wizard: `The Wizard keeps the room dim. Nothing gets worse, but nothing is taught yet. The next unexpected change may look the same. ABA Anchor: Stabilization needs to be followed by replacement practice.`,
            ending: "mixed",
            meta: {
              bipComponent: "Respond",
              mechanism: "Adaptation",
          ...
          C: {
            ...
            wizard: `The Wizard sounds the alarm. The new room becomes another conversation about failure. Student moves farther from participation and closer to escape. ABA Anchor: Reflection belongs after regulation, re-entry, and reinforcement.`,
            ending: "fail",
            meta: {
              bipComponent: "Respond",
              mechanism: "Adaptation",
