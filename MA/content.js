...
GAME_CONFIG.fidelityHigh = `High fidelity. You stayed calm and brief, redirected without spotlighting, and reinforced the right behaviors quickly. KeKu got a clear path back to success.`;
...
POOL.daily.push({
  ...
  steps: {
    step1: {
      text: `During whole-group instruction, KeKu starts sliding backward and lightly pokes the student next to him. When you begin directions, he says he is not doing this and looks for reactions.`,
      choices: {
    ...
    step2: {
      text: `KeKu moves to his assigned spot and quiets his hands. How do you follow up?`,
      choices: {
    ...
    step3: {
      text: `KeKu is in his spot and starting the task. How do you reinforce?`,
      choices: {
  ...
  endings: {
    success: { title: `Success — Routine Strengthened`, text: `KeKu started whole-group successfully using choices, incompatible directions, and Chart Move reinforcement.` },
    mixed:   { title: `Mixed — Stable but Under-Reinforced`, text: `KeKu complied, but the team missed a chance to strengthen the routine.` },
...
POOL.daily.push({
  ...
  steps: {
    step1: {
      text: `Independent work begins. KeKu looks at the worksheet, sighs loudly, and starts folding the corner of the paper while watching nearby peers.`,
      choices: {
    ...
    step2: {
      text: `KeKu pauses, then flattens the paper and looks at the bottom problem. What next?`,
      choices: {
    ...
    step3: {
      text: `KeKu begins writing. How do you reinforce this moment?`,
      choices: {
  ...
  endings: {
    ...
    mixed:   { title: `Mixed — Partial Engagement`, text: `KeKu stayed regulated but reinforcement was missed.` },
...
POOL.daily.push({
  ...
  steps: {
    step1: {
      text: `You announce a transition to partner work. KeKu immediately says loudly that he does not want a partner and looks around for reactions.`,
      choices: {
    ...
    step2: {
      text: `KeKu hesitates, then points to a partner. What do you do next?`,
      choices: {
    ...
    step3: {
      text: `KeKu sits with his partner and opens the materials. How do you reinforce the transition?`,
      choices: {
  ...
  endings: {
    success: { title: `Success — Transition Completed`, text: `KeKu transitioned to partner work using choices and clear structure.` },
    mixed:   { title: `Mixed — Partial Transition`, text: `KeKu transitioned but reinforcement was missed.` },
...
POOL.daily.push({
  ...
  steps: {
    step1: {
      text: `The class returns from PE. KeKu is energized and begins wandering past his desk, bumping into chairs and drifting toward the door.`,
      choices: {
        ...
        C: { text: `Say loudly: KeKu, get back to your seat.`, score: -10, feedback: `Public call-out may escalate movement.`, next: "step2" }
      }
    },
    step2: {
      text: `KeKu walks toward the end-of-row seat and pauses. What do you say?`,
      choices: {
    ...
    step3: {
      text: `KeKu sits down and stays in his seat. How do you reinforce?`,
      choices: {
...
POOL.daily.push({
  ...
  steps: {
    step1: {
      text: `KeKu is given a writing prompt. He sighs loudly, pushes the paper slightly away, and says it is too hard while glancing at nearby peers.`,
      choices: {
    ...
    step2: {
      text: `KeKu pulls the paper back toward him but keeps watching peers. What next?`,
      choices: {
    ...
    step3: {
      text: `KeKu begins writing quietly. How do you reinforce?`,
      choices: {
  ...
  endings: {
    ...
    mixed:   { title: `Mixed — Partial Engagement`, text: `KeKu stayed regulated but did not fully engage.` },
...
POOL.daily.push({
  ...
  steps: {
    step1: {
      text: `As you explain a math problem, KeKu blurts out that it is easy and looks around to see who noticed.`,
      choices: {
    ...
    step2: {
      text: `KeKu quiets and raises his hand. How do you respond?`,
      choices: {
    ...
    step3: {
      text: `KeKu waits quietly with his hand raised. How do you reinforce math participation?`,
      choices: {
...
POOL.daily.push({
  ...
  steps: {
    step1: {
      text: `KeKu enters the classroom with high energy, weaving between desks and calling out to peers instead of going to his seat.`,
      choices: {
        ...
        C: { text: `Say loudly: KeKu, stop running around.`, score: -10, feedback: `Public attention may escalate movement.`, next: "step2" }
      }
    },
    step2: {
      text: `KeKu heads to the backpack hook and slows slightly. What do you say?`,
      choices: {
    ...
    step3: {
      text: `KeKu sits at his desk and stays seated. How do you reinforce morning entry?`,
      choices: {
...
POOL.daily.push({
  ...
  steps: {
    step1: {
      text: `During a whole-class discussion, KeKu blurts out the answer loudly and looks around to see who noticed.`,
      choices: {
    ...
    step3: {
      text: `KeKu holds his hand up and stays quiet. How do you reinforce?`,
      choices: {
  ...
  endings: {
    ...
    mixed:   { title: `Mixed — Participation Without Reinforcement`, text: `KeKu participated, but reinforcement was not clearly tied to replacement behavior.` },
...
POOL.daily.push({
  ...
  steps: {
    step1: {
      text: `During independent work, KeKu gets stuck and calls out loudly across the room that he does not get this, looking around for reactions.`,
      choices: {
    ...
    step2: {
      text: `KeKu hesitates, then uses the help signal and raises his hand quietly. How do you respond?`,
      choices: {
    ...
    step3: {
      text: `KeKu stays seated and waits using the help routine. How do you finalize support?`,
      choices: {
...
POOL.daily.push({
  ...
  steps: {
    step1: {
      text: `During end-of-day cleanup, KeKu leaves his area and drifts toward peers, touching items on other desks instead of packing up.`,
      choices: {
    ...
    step2: {
      text: `KeKu pauses and returns toward his desk. What do you say next?`,
      choices: {
    ...
    step3: {
      text: `KeKu packs up at his desk and stays there. How do you reinforce?`,
      choices: {
  ...
  endings: {
    ...
    mixed:   { title: `Mixed — Routine Completed Without Reinforcement`, text: `KeKu packed up, but reinforcement was not tied to expected behaviors.` },
...
POOL.crisis.push({
  ...
  steps: {
    step1: {
      text: `During line-up, KeKu suddenly kicks toward a peer and swings his arm when they get too close. Several students react.`,
      choices: {
    ...
    step2: {
      text: `Peers move away. KeKu slows slightly but is still tense. What do you do?`,
      choices: {
    ...
    step3: {
      text: `KeKu is separated from peers and begins to calm. How do you support recovery?`,
      choices: {
...
POOL.crisis.push({
  ...
  steps: {
    step1: {
      text: `During a challenging task, KeKu refuses, pushes materials away, and begins yelling that he is not doing this.`,
      choices: {
    ...
    step2: {
      text: `KeKu pauses and lowers his voice slightly. What do you do?`,
      choices: {
    ...
    step3: {
      text: `KeKu calms and stops yelling. How do you support recovery?`,
      choices: {
...
POOL.crisis.push({
  ...
  steps: {
    ...
    step2: {
      text: `KeKu slows near the doorway but looks unsure. What do you offer?`,
      choices: {
    ...
    step3: {
      text: `KeKu stops and waits with support nearby. How do you support recovery?`,
      choices: {
...
POOL.crisis.push({
  ...
  steps: {
    step1: {
      text: `During a demanding task, KeKu grabs classroom materials and begins throwing them onto the floor. Peers turn to watch.`,
      choices: {
    ...
    step2: {
      text: `With peers moved away, KeKu pauses and breathes hard. What do you do?`,
      choices: {
    ...
    step3: {
      text: `KeKu moves toward the reset space and stops throwing. How do you support recovery?`,
      choices: {
...
POOL.crisis.push({
  ...
  steps: {
    step1: {
      text: `KeKu becomes escalated, kicks toward a peer, then immediately turns and moves quickly toward the door.`,
      choices: {
    ...
    step2: {
      text: `With peers separated and support signaled, KeKu pauses at the doorway breathing hard. What do you offer?`,
      choices: {
    ...
    step3: {
      text: `KeKu slows and begins to calm with support present. What is the best next step?`,
      choices: {
...
POOL.wild.push({
  ...
  steps: {
    step1: {
      text: `An announcement comes over the intercom: your class must move to a different room right away. KeKu tenses, steps away from the line, and loudly asks why you are going there.`,
      choices: {
    ...
    step2: {
      text: `KeKu steps closer but keeps scanning the hallway and peers. What do you offer?`,
      choices: {
    ...
    step3: {
      text: `KeKu arrives at the new location and is calm enough to participate. What is the best next step?`,
      choices: {
  ...
  endings: {
    ...
    mixed:   { title: `Mixed — Moved But Not Strengthened`, text: `KeKu complied, but flexibility and coping were not clearly reinforced.` },
...
POOL.wild.push({
  ...
  steps: {
    step1: {
      text: `A planned activity ends early and you suddenly have 10 minutes of open time. KeKu seeks a peer, gets too close, and begins bumping bodies. The peer says stop, and KeKu's posture stiffens.`,
      choices: {
    ...
    step2: {
      text: `KeKu hesitates, then looks at the activity options, still buzzing with energy. What do you offer?`,
      choices: {
    ...
    step3: {
      text: `KeKu moves to a chosen activity spot and begins engaging with materials. How do you finish the block?`,
      choices: {
...
POOL.wild.push({
  ...
  steps: {
    step1: {
      text: `A substitute is in the room. KeKu notices immediately and begins testing limits — refusing a direction and grinning at peers like he is performing.`,
      choices: {
        A: { text: `Keep routine predictable: give the sub a quick script and use a brief directive to KeKu — same routine, start now.`, score: 10, feedback: `Excellent. Predictability reduces attention-seeking and prevents limit-testing from escalating.`, next: "step2" },
    ...
    step2: {
      text: `KeKu hesitates, then starts moving but watches peers to see if they are impressed. How do you respond?`,
      choices: {
    ...
    step3: {
      text: `KeKu begins participating in the routine with the substitute present. How do you conclude the period?`,
      choices: {
  ...
  endings: {
    ...
    mixed:   { title: `Mixed — Participated But Testing May Return`, text: `KeKu participated, but generalization was not clearly reinforced.` },
...
POOL.wild.push({
  ...
  steps: {
    step1: {
      text: `KeKu is using a Chromebook for an activity. The screen freezes. He jabs the keys, raises his voice, and says it is not working while looking around to see who is watching.`,
      choices: {
    ...
    step2: {
      text: `KeKu lowers his hands but keeps breathing fast and glancing at peers. What do you offer?`,
      choices: {
    ...
    step3: {
      text: `KeKu chooses an option and his breathing slows. He is able to re-engage. What is the best wrap-up?`,
      choices: {
  ...
  endings: {
    success: { title: `Success — Frustration Coping Strengthened`, text: `KeKu used a coping option and rejoined successfully; coping was reinforced with a Chart Move.` },
...
POOL.wild.push({
  ...
  steps: {
    step1: {
      text: `A visitor enters and sits in the back of the room. KeKu notices instantly. He starts narrating loudly, making jokes, and watching peers to see if they laugh.`,
      choices: {
        A: { text: `Pre-correct quietly and keep the routine: same expectations, start with number one. Give the visitor a neutral update out of earshot if needed.`, score: 10, feedback: `Excellent. You avoid spotlighting KeKu and keep structure predictable.`, next: "step2" },
        B: { text: `Tell the visitor in front of KeKu that he sometimes struggles with behavior.`, score: 0, feedback: `Neutral, but it can create a performance stage and reinforce peer attention behavior.`, next: "step2" },
        C: { text: `Publicly correct KeKu: stop trying to show off because someone is here.`, score: -10, feedback: `Public calling-out increases attention and can escalate behavior.`, next: "step2" }
      }
    },
    step2: {
      text: `KeKu quiets slightly and starts the task, but keeps glancing at the visitor. How do you respond?`,
      choices: {
    ...
    step3: {
      text: `KeKu stabilizes and works within expectations with the visitor present. How do you end the observation period?`,
      choices: {
